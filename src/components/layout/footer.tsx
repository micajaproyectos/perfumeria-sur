      ...
      <div className="container mx-auto px-4 max-w-7xl py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            <div className="mb-4">
              <Image
                src="/images/Logo_perfumería_sur.png"
                alt="Perfumería Sur"
                width={160}
                height={80}
            ...
            <p className="text-sm text-cream/70 leading-relaxed">
              Perfumes originales de lujo y árabes para hombre y mujer. Precios
              accesibles, calidad garantizada. Envíos a todo Chile.
            </p>
          </div>

          {/* Links */}
          <div>
            <h4 className="text-xs tracking-widest uppercase font-semibold text-primary mb-4">
              Catálogo
            </h4>
            <ul className="space-y-2 text-sm text-cream/70">
              ...
              <li>
                <Link
                  href="/catalogo?sort=mas-vendidos"
                  className="hover:text-primary transition-colors"
                >
                  Más vendidos
                </Link>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-cream/70">
              <li className="flex items-start gap-2">
                ...
                <span>Futaleufú, Patagonia Chilena</span>
              </li>
              <li className="flex items-start gap-2">
                <MapPin className="h-4 w-4 shrink-0 mt-0.5 text-primary" />
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a
                href="https://wa.me/56985660954?text=Hola%2C%20quiero%20conocer%20su%20tienda%20f%C3%ADsica."
                target="_blank"
              ...
              <a
                href="https://www.instagram.com/millanolli.chile/"
                target="_blank"
                rel="noopener noreferrer"
